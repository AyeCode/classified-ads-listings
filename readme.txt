...
Classifieds is a modern and responsive WordPress theme designed for classifieds directory and recruitment directory websites.
...
= 1.0.4 =
* Theme URI broken due to name change - FIXED
...
* Logo image header and footer ( logo-dark.png & logo-white.png), Copyright AyeCode Ltd
...
* Font files montserrat (assets/fonts/josefin_sans/*), Copyright 2010 The Josefin Sans Project Authors
  ...
  Source: https://github.com/googlefonts/josefinsans

* Font files montserrat (assets/fonts/montserrat/*), Copyright 2024 The Montserrat.Git Project Authors
  License: SIL OPEN FONT LICENSE Version 1.1
